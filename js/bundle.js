!(function (t) {
  ...
  function (t, e, n) {
    ...
    K &&
      ...
      a({ global: !0, wrap: !0, forced: K }, { Promise: F }),
      d(F, R, !1, !0),
      h(R),
      (i = f(R)),
      a(
  ...
  function (t, e, n) {
    ...
    (t.exports = function (t, e, n, f, l) {
      ...
      if (l) p = t;
        ...
        if (o(v)) {
          for (d = 0, h = i(t.length); h > d; d++)
            if ((y = f ? x(r((m = t[d]))[0], m[1]) : x(t[d])) && y instanceof s)
              return y;
          return new s(!1);
        }
        p = v.call(t);
      ...
      for (g = p.next; !(m = g.call(p)).done; )
        if ("object" == typeof (y = u(p, x, m.value, f)) && y && y instanceof s)
          return y;
      return new s(!1);
    }).stop = function (t) {
      return new s(!0, t);
  ...
  function (t, e, n) {
    ...
    (d && h) ||
      ...
      "process" == u(y)
        ...
        : ((r = _), c.addEventListener("message", S, !1))),
      ...
      { target: "Array", proto: !0, forced: !v || !d },
      {
        slice: function (t, e) {
          ...
          if (
            ...
            return y.call(l, v, d);
          for (
            r = new (void 0 === n ? Array : n)(g(d - v, 0)), f = 0;
            v < d;
            v++, f++
          )
            v in l && s(r, f, l[v]);
        ...
        (E.prototype = {
          ...
          finish: function (t) {
            for (var e = this.tryEntries.length - 1; e >= 0; --e) {
              ...
              if (n.finallyLoc === t)
                return this.complete(n.completion, n.afterLoc), b(n), s;
            }
          },
          catch: function (t) {
            for (var e = this.tryEntries.length - 1; e >= 0; --e) {
      ...
      if (
        (T &&
          ...
          d !== Object.prototype &&
            ...
            (l ||
              i(w) === d ||
              (c ? c(w, d) : "function" != typeof w[y] && u(w, y, g)),
            a(w, _, !0, !0),
            l && (p[_] = g))),
        "values" == v &&
          j &&
      ...
      return [
        ...
        function (t, r) {
          ...
          for (var S, _ = "", L = 0, O = 0; O < b.length; O++) {
            ...
            for (
              var j = String(E[0]),
                A = l(p(a(E.index), v.length), 0),
                T = [],
                P = 1;
              P < E.length;
              P++
            )
              T.push(void 0 === (S = E[P]) ? S : String(S));
            var I = E.groups;
            if (d) {
  ...
  function (t, e, n) {
      ...
      var t = (function () {
        function t(e, n, r, o, i, c) {
          p(this, t),
            ...
            (this.price = i);
          for (
            var a = arguments.length, u = new Array(a > 6 ? a - 6 : 0), s = 6;
            s < a;
            s++
          )
            u[s - 6] = arguments[s];
    ...
    var h = function () {
      ...
      function c() {
        i.textContent =
          t && e && n && r && o
            ? "female" === t
              ? Math.round((447.6 + 9.2 * n + 3.1 * e - 4.3 * r) * o)
              : Math.round((88.36 + 13.4 * n + 4.8 * e - 5.7 * r) * o)
            : "____";
      }
      function a(t, e) {
        document.querySelectorAll(t).forEach(function (t) {
          t.classList.remove(e),
            t.getAttribute("id") === localStorage.getItem("sex") &&
              t.classList.add(e),
            t.getAttribute("data-ratio") === localStorage.getItem("ratio") &&
              t.classList.add(e);
        });
      }
      function u(e, n) {
    ...
    var g = function (t) {
      ...
      l.length < 10
        ? ((h.textContent = "0".concat(l.length)),
          (y.textContent = "0".concat(f)))
        : ((h.textContent = l.length), (y.textContent = f)),
      ...
      for (var E = 0; E < l.length; E++) {
        ...
        S.setAttribute("data-slide-to", E + 1),
          (S.style.cssText =
            "\n            box-sizing: content-box;\n            flex: 0 1 auto;\n            width: 30px;\n            height: 6px;\n            margin-right: 3px;\n            margin-left: 3px;\n            cursor: pointer;\n            background-color: #fff;\n            background-clip: padding-box;\n            border-top: 10px solid transparent;\n            border-bottom: 10px solid transparent;\n            opacity: .5;\n            transition: opacity .6s ease;\n        "),
          0 == E && (S.style.opacity = 1),
          w.append(S),
          b.push(S);
      }
      function _(t) {
      ...
      d.addEventListener("click", function () {
        s == _(m) * (l.length - 1) ? (s = 0) : (s += _(m)),
          (x.style.transform = "translateX(-".concat(s, "px)")),
          f == l.length ? (f = 1) : f++,
          l.length < 10 ? (y.textContent = "0".concat(f)) : (y.textContent = f),
